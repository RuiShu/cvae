...
local opfunc = function(parameters_input, x_input, y_input)
   ...
   local kld_err = kld:forward(out[1], out[2])*weight
   -- backprop
   ...
   local error_grads = TableConcat({dmulog, {drecon}})
